...
function setupDeviceSettings() {
  ...
  (deviceSettings.isAndroid = -1 < t.indexOf("android")),
    ...
    (deviceSettings.isIEMobile =
      null !== navigator.userAgent.match(/iemobile/i));
...
function initWebgl() {
  setupDeviceSettings(),
    ...
    gsap.set(
      "#hud, #hud-darken, #iss_target, #navball, #translation-status, #rotation-controls, #translation-controls, #helpers, #instructions",
      { autoAlpha: 0 }
    ),
  ...
  t.appendChild(navballRenderer.domElement),
    ...
    document
      .getElementById("iss_labels")
      .appendChild(tooltipRenderer.domElement),
...
function initPreloader() {
  (earthTexture = deviceSettings.isMobile
    ? textureLoader.load("img/earth_mobile.jpg")
    ...
    (forwardViewSpriteTexture = textureLoader.load(
      "img/hud/ForwardViewSprites2.png"
    )),
...
function initButtons() {
  deviceSettings.isMobile
    ? ($("#begin-button").addEventListener("touchstart", hideIntro, !1),
      ...
      $("#instructions-button").addEventListener(
        "touchstart",
        instructionsOpen,
        !1
      ),
      $("#option-instructions").addEventListener(
        "touchstart",
        instructionsOpen,
        !1
      ),
      $("#instructions .modal-close").addEventListener(
        "touchstart",
        instructionsClose,
        !1
      ),
      ...
      $("#settings .modal-close").addEventListener(
        "touchstart",
        settingsClose,
        !1
      ),
      ...
      $("#translate-forward-button").addEventListener(
        "touchstart",
        translateForward,
        !1
      ),
      $("#translate-backward-button").addEventListener(
        "touchstart",
        translateBackward,
        !1
      ),
      $("#translate-down-button").addEventListener(
        "touchstart",
        translateDown,
        !1
      ),
      $("#translate-up-button").addEventListener("touchstart", translateUp, !1),
      $("#translate-right-button").addEventListener(
        "touchstart",
        translateRight,
        !1
      ),
      $("#translate-left-button").addEventListener(
        "touchstart",
        translateLeft,
        !1
      ),
      $("#toggle-translation").addEventListener(
        "touchstart",
        toggleTranslation,
        !1
      ),
    ...
    document.addEventListener("keydown", function (t) {
      if (!isGameOver) {
        ...
        (flightInput = t.keyCode + flightInput),
          ...
          ("728482656984657670" === flightInput.substring(0, 18) ||
            "7284826569" === flightInput.substring(0, 10)) &&
            toggleEarthShape();
      }
    }),
...
function resetPrecision() {
  $("#rotation-controls").classList.contains("large") &&
    ...
    $("#translation-controls").classList.contains("large") &&
...
function showIntroHelpers() {
  gsap.set("#logoSVG, #intro-step1", { display: "none" }),
    ...
    gsap.fromTo(
      "#intro-step2 h2, #intro-step2 p, #intro-step2 .message-button",
      2,
      { y: 50, autoAlpha: 0 },
      { y: 0, autoAlpha: 1, ease: "expo.out", stagger: 0.25 }
    );
}
function hideIntro() {
  isIntroStarted ||
...
function showInterface() {
  (interfaceAnimationIn = new TimelineMax({
    ...
    interfaceAnimationIn.fromTo(
      "#rotation-controls, #translation-controls",
      0.5,
      { autoAlpha: 0 },
      { autoAlpha: 1, ease: "none" },
      0
    ...
    interfaceAnimationIn.staggerFromTo(
      "#hud .hud-item .error, #hud .hud-item .rate, #pyr .distance",
      1,
      { autoAlpha: 0 },
      { autoAlpha: 1, ease: "none" },
      0.1,
    ...
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "RANGE", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3
    ),
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "RATE", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3
    ),
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "ROLL", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3.25
    ),
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "PITCH", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3.25
    ),
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "XYZ", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3.25
    ),
    interfaceAnimationIn.fromTo(
      ...
      { scrambleText: { text: " " } },
      {
        scrambleText: { text: "YAW", chars: "0123456789!@#$%^&*()" },
        ease: "none",
      },
      3.25
    ),
...
function hideInterface(t) {
  (isGameOver = !0),
    ...
    interfaceAnimationOut.to(
      "#hud, #iss_target, #navball, #helpers",
      1.5,
      { autoAlpha: 0, ease: Linear.easeOut },
      0
    ),
    ...
    "success" === t &&
      ...
      interfaceAnimationOut.fromTo(
        ...
        { scrambleText: { text: " " } },
        {
          scrambleText: { text: "SUCCESS", chars: "0123456789!@#$%^&*()" },
          ease: "none",
        },
        2
      ),
    ...
    "fail" === t &&
      ...
      interfaceAnimationOut.fromTo(
        ...
        { scrambleText: { text: " " } },
        {
          scrambleText: { text: "GAME OVER", chars: "0123456789!@#$%^&*()" },
          ease: "none",
        },
        2
      ),
...
function createLights() {
  (lightObject = new THREE.Object3D()),
    ...
    lightColorAnimation.to(
      lightColorArray,
      2,
      { r: lightColor1.r, g: lightColor1.g, b: lightColor1.b },
      0
    ),
    lightColorAnimation.to(
      lightColorArray,
      2,
      { r: lightColor2.r, g: lightColor2.g, b: lightColor2.b },
      2
    ),
    lightColorAnimation.to(
      lightColorArray,
      2,
      { r: lightColor3.r, g: lightColor3.g, b: lightColor3.b },
      4
    ),
    lightColorAnimation.to(
      lightColorArray,
      2,
      { r: lightColorWhite.r, g: lightColorWhite.g, b: lightColorWhite.b },
      6
    ),
    lightColorAnimation.to(
      lightColorArray,
    ...
    (warpVars.isFinished ||
      (isIntroStarted
        ? !warpVars.isTriggered &&
          (gsap.to(lightVars, 1, { velocity: 12, intensity: 10 }),
          lightColorAnimation.play())
        : warpVars.isTriggered &&
  ...
  wormholeCreated &&
    (warpVars.isFinished ||
      (isIntroStarted
        ...
        : warpVars.isTriggered &&
          (gsap.to(wormholeVars, 2, { opacity: 0 }),
          gsap.to(wormholeVars, 2, { textureSpeed: 0, rotationSpeed: 0 }),
          gsap.to(wormholeObject.scale, 1.25, { z: 1 }))),
    0 >= wormholeVars.opacity
      ? wormholeObject.visible && (wormholeObject.visible = !1)
      : ((wormholeMaterial.opacity = wormholeVars.opacity),
        (wormholeObject.rotation.z -= 0.001 * wormholeVars.rotationSpeed),
        (wormholeTexture.offset.y -= 0.001 * wormholeVars.textureSpeed),
        (wormholeMaterial.needsUpdate = !0)));
}
var tunnelObject,
  tunnelTexture,
  ...
  tunnelCreated &&
    (warpVars.isFinished ||
      (isIntroStarted
        ...
        : warpVars.isTriggered &&
          (gsap.to(tunnelVars, 2, { opacity: 0 }),
          gsap.to(tunnelVars, 2, { textureSpeed: 0.1, rotationSpeed: 1 }))),
    0 >= tunnelVars.opacity
      ? tunnelObject.visible && (tunnelObject.visible = !1)
      : ((tunnelMaterial.opacity = tunnelVars.opacity),
        (tunnelObject.rotation.z -= 0.001 * tunnelVars.rotationSpeed),
        (tunnelTexture.offset.y -= 0.001 * tunnelVars.textureSpeed),
        (tunnelMaterial.needsUpdate = !0)));
}
var sonicObject,
  sonicTexture,
...
function createStarfield() {
  for (
    starfieldObject = new THREE.Group(),
      ...
      starfieldMaterialColorArray = [
        starfieldMaterialBlue.color,
        starfieldMaterialOrange.color,
        starfieldMaterialWhite.color,
      ],
      starfieldColorTotal = starfieldMaterialArray.length - 1,
      deviceSettings.isMobile &&
        ((starfieldTotal = Math.floor(starfieldTotal / 3)),
        (starfieldScaleFactor = 1)),
      i = 0;
    i < starfieldTotal;
    i++
  ...
  if (starfieldCreated) {
    ...
    for (var t, e = 0; e < starfieldDetailsArray.length; e++)
      (t = starfieldDetailsArray[e]),
        ...
        (starfieldSpritesArray[e].scale.y =
          t.scale * starfieldVars.scale * starfieldVars.stretch),
...
function updateDistance() {
  warpVars.isFinished ||
    (isIntroStarted
      ? !warpVars.isTriggered &&
        ((warpVars.isTriggered = !0),
        gsap.to(warpVars, 1, { distanceSpeed: 5512 }))
      : warpVars.isTriggered &&
        ((warpVars.isTriggered = !1),
        gsap.to(warpVars, 1, { distanceSpeed: 0.1 })),
    (warpVars.distanceCurrent -= warpVars.distanceSpeed),
    0 >= warpVars.distanceCurrent &&
      ((warpVars.isFinished = !0),
...
function updateWarpStatus() {
  warpVars.isFinished ||
    (isIntroStarted
      ? !warpVars.isTriggered && (warpVars.isTriggered = !0)
...
function createStars() {
  for (
    starsObject = new THREE.Group(),
      ...
      starMaterialColorArray = [
        starMaterialBlue.color,
        starMaterialOrange.color,
        starMaterialWhite.color,
      ],
      starColorTotal = starMaterialArray.length - 1,
      deviceSettings.isMobile &&
        ((starTotal = Math.floor(starTotal / 3)), (starScaleFactor = 1.5)),
      i = 0;
    i < starTotal;
    i++
  ) {
...
function createEarth() {
  (earthObject = new THREE.Object3D()),
    ...
    (earthMesh = new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({ map: earthTexture, shininess: 0 })
    )),
...
function createFlatEarth() {
  (flatEarthObject = new THREE.Object3D()),
    ...
    (flatEarthMesh = new THREE.Mesh(
      new THREE.PlaneGeometry(2048, 2048, 32),
      new THREE.MeshPhongMaterial({ map: flatEarthTexture, transparent: !0 })
    )),
...
function renderEarth() {
  isFlatEarth &&
    (flatEarthMesh.rotation.z = flatEarthMesh.rotation.z += 0.05 * toRAD);
}
...
function createRings() {
  for (
    orbRingObject = new THREE.Object3D(),
  ...
  for (
    var e = orbFadeTarget.getWorldPosition(new THREE.Vector3()),
      o = new Float32Array(3 * orbRingVerticesArray.length),
      a = new Float32Array(orbRingVerticesArray.length),
      r = 0;
    r < orbRingVerticesArray.length;
    r++
  ) {
  ...
  orbRingBufferGeometry.setAttribute(
    "position",
    new THREE.BufferAttribute(o, 3)
  ),
    orbRingBufferGeometry.setAttribute(
      "alpha",
      new THREE.BufferAttribute(a, 1)
    ),
    (orbRingMesh1 = new THREE.LineLoop(
      orbRingBufferGeometry,
      orbRingShaderMaterial
    )),
...
function renderOrb() {
  if (isOrbCreated) {
    ...
    for (i = 0; i < orbSpriteArray.length; i++) {
      ...
      orbSpriteArray[i].material.uniforms.u_opacity.value =
        opacityDistanceClamp(o, 5, 2, 1);
    }
  }
}
var issObject,
      ...
      function (t) {
        function e(t, e) {
          var o = new THREE.Mesh(
            new THREE.TorusGeometry(10, 0.3, 5, 6),
...
function renderTesla() {
  2.5 < camera.rotation.y || -2.5 > camera.rotation.y
    ? (!isTeslaCreated && createTesla(),
      isTeslaLoaded && (teslaMesh.visible = !0))
    : isTeslaLoaded && (teslaMesh.visible = !1);
}
...
function createNavball() {
  (navballRotationObject = new THREE.Group()),
    ...
    (navballLights = new THREE.PointLight(
      navballLightsColor,
      navballLightsIntensity,
      navballLightsDistance,
      navballLightsDecay
    )),
  ...
  if ((scene.updateMatrixWorld(), isWarpComplete)) {
    (currentRotationX = currentRotationX +=
      ...
      (currentRotationY = currentRotationY +=
        (0.01 * -targetRotationY - currentRotationY) * moveSpeed),
      (currentRotationZ = currentRotationZ +=
        (0.01 * -targetRotationZ - currentRotationZ) * moveSpeed),
      ...
      (currentLocationX = currentLocationX +=
        (-0 - currentLocationX) * moveSpeed),
      (currentLocationY = currentLocationY +=
        (-0 - currentLocationY) * moveSpeed),
      (currentLocationZ = currentLocationZ +=
        (-0 - currentLocationZ) * moveSpeed),
    ...
    if (
      (($("#range .rate").innerHTML = n.toFixed(1) + " m"),
      (rangeRateCounter += 1),
      20 <= rangeRateCounter)
    ) {
      rangeRateCounter = 0;
      ...
      (rateCurrent = 0.75 * (1e3 * ((n - prevRange) / (s - prevRangeTime)))),
        (smoothRangeRate +=
          (rateCurrent - smoothRangeRate) / rateSmoothingFactor),
    ...
    (camera.position.x += 0.01 * (mouseX - camera.position.x)),
      (camera.position.y += 0.01 * (-mouseY - camera.position.y)),
...
function checkCollision() {
  if (!0 !== isGameOver) {
    ...
    if (
      ...
      0.02 <= i || 0.02 <= n || 0.02 <= s
        ? updateRateColor("warning")
        : i > toleranceRate || n > toleranceRate || s > toleranceRate
        ? updateRateColor("caution")
        : updateRateColor("normal"),
      0 < t.length &&
        (($("#fail-message").innerHTML =
          "You made contact with the International Space Station."),
        hideInterface("fail")),
      500 < e &&
        (($("#fail-message").innerHTML =
          "You are too far away from the International Space Station."),
        hideInterface("fail")),
      ...
      if (
        ...
        (o > toleranceRotation ||
          ...
          (i > toleranceRate || n > toleranceRate || s > toleranceRate) &&
            ("" != l && (l += ", "), (l += "SPEED")),
          ($("#fail-message").innerHTML =
            "The following errors occurred: <span class='red'>" + l + "<span>"),
          hideInterface("fail");
      }
  }
}
function rollLeft() {
  !0 === isGameOver ||
    ...
    gsap.fromTo(
      "#tip-roll-left",
      1.25,
      { rotation: -25, autoAlpha: 1 },
      { rotation: -90, autoAlpha: 0, ease: "expo.out" }
    ),
    updateWorm("roll"));
}
function rollRight() {
...
function pitchDown() {
  !0 === isGameOver ||
    ...
    gsap.fromTo(
      "#tip-pitch-down",
      1.25,
      { rotation: 180, rotationX: -25, autoAlpha: 1 },
      { rotationX: -90, autoAlpha: 0, ease: "expo.out" }
    ),
    updateWorm("pitch"));
}
function pitchUp() {
...
function yawLeft() {
  !0 === isGameOver ||
    ...
    gsap.fromTo(
      "#tip-yaw-left",
      1.25,
      { rotation: -90, rotationX: -25, autoAlpha: 1 },
      { rotationX: -90, autoAlpha: 0, ease: "expo.out" }
    ),
    updateWorm("yaw"));
}
...
function translateDown() {
  !0 === isGameOver ||
    ...
    motionVector.add(translationVector),
    gsap.fromTo(
      "#tip-translatey-pos .arrow1",
      2,
      { x: 0, scale: 1, autoAlpha: 1 },
      { x: -50, scale: 1, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatey-pos .arrow2",
      2,
      { x: -5, scale: 1, autoAlpha: 1 },
      { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatey-pos .arrow3",
      2,
      { x: -10, scale: 1, autoAlpha: 1 },
      { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }
    ));
}
function translateUp() {
  !0 === isGameOver ||
    ...
    motionVector.add(translationVector),
    gsap.fromTo(
      "#tip-translatey-neg .arrow1",
      2,
      { x: 0, scale: 1, autoAlpha: 1 },
      { x: -50, scale: 1, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatey-neg .arrow2",
      2,
      { x: -5, scale: 1, autoAlpha: 1 },
      { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatey-neg .arrow3",
      2,
      { x: -10, scale: 1, autoAlpha: 1 },
      { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }
    ));
...
function translateRight() {
  !0 === isGameOver ||
    ...
    motionVector.add(translationVector),
    gsap.fromTo(
      "#tip-translatex-pos .arrow1",
      2,
      { x: 0, scale: 1, autoAlpha: 1 },
      { x: -50, scale: 1, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatex-pos .arrow2",
      2,
      { x: -5, scale: 1, autoAlpha: 1 },
      { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatex-pos .arrow3",
      2,
      { x: -10, scale: 1, autoAlpha: 1 },
      { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }
    ));
...
function translateLeft() {
  !0 === isGameOver ||
    ...
    motionVector.add(translationVector),
    gsap.fromTo(
      "#tip-translatex-neg .arrow1",
      2,
      { x: 0, scale: 1, autoAlpha: 1 },
      { x: -50, scale: 1, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatex-neg .arrow2",
      2,
      { x: -5, scale: 1, autoAlpha: 1 },
      { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }
    ),
    gsap.fromTo(
      "#tip-translatex-neg .arrow3",
      2,
      { x: -10, scale: 1, autoAlpha: 1 },
      { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }
    ));
...
function updateWorm(t) {
  ...
  "roll" === t
    ? ((wormRate = updateWormRate(rateRotationZ)),
      updateWormRateColor(rateRotationZ, "roll"),
      0 > rateRotationZ
        ? (e = 48 + wormRate + "% " + wormPercentageBase + "%")
        : 0 === rateRotationZ
        ? (e = "48.5% 51.5%")
        : 0 < rateRotationZ && (e = "50% " + (52 + wormRate) + "%"))
    : "pitch" === t
    ? ((wormRate = updateWormRate(rateRotationX)),
      ...
      0 > rateRotationX
        ...
        : 0 === rateRotationX
        ? (e = "48.5% 51.5%")
        : 0 < rateRotationX && (e = "50% " + (52 + wormRate) + "%"))
    : "yaw" === t
...
function updateWormRate(t) {
  return (
    t <= -wormRateClamp
      ? (t = -wormRateClamp)
      : t >= wormRateClamp && (t = wormRateClamp),
    t
  );
}
...
function instructionsOpen() {
  gsap.fromTo(
    ...
    gsap.fromTo(
      "#instructions #arrow-prev",
      1,
      { x: 25, autoAlpha: 0 },
      { x: 0, autoAlpha: 1, ease: Expo.easeOut }
    ),
    gsap.fromTo(
      "#instructions #arrow-next",
      1,
      { x: -25, autoAlpha: 0 },
      { x: 0, autoAlpha: 1, ease: Expo.easeOut }
    ),
...
function instructionsChange() {
  ...
  gsap.set(".instruction-item", { autoAlpha: 0, display: "none" }),
    gsap.fromTo(
      ...
      0.5,
      { autoAlpha: 0 },
      { autoAlpha: 1, display: "inline-block", ease: "none" }
    ),
    gsap.fromTo(
      t + " h3",
      1,
    ...
    gsap.fromTo(
      ...
      { scale: 1, autoAlpha: 1, ease: "expo.out" }
    ),
    ($("#instructions-status").innerHTML =
      instructionsStep + " / " + instructionsTotal);
}
...
function toggleGravity() {
  isGravity
    ? ((isGravity = !1),
      ...
      ($("#setting-gravity span").innerHTML = "OFF"))
    : ((isGravity = !0),
  ...
  isFlatEarthCreated || createFlatEarth(),
    isFlatEarth
      ? ((isFlatEarth = !1),
        ...
        (flatEarthObject.visible = !1),
        ($("#setting-earth span").innerHTML = "OBLATE SPHEROID"))
      : ((isFlatEarth = !0),
...
function onDocumentMouseMove(t) {
  !1 === isEventsEnabled ||
    ((mouseX = 0.001 * (t.clientX - windowHalfX)),
    (mouseY = 0.001 * (t.clientY - windowHalfY)));
}
